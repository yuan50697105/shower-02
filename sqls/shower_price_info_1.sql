...
INSERT INTO shower.price_info (id, create_time, update_time, create_user, update_user, code, type, price_code,
                               time_price, time_interval, time_unit, water_price, water_interval, water_unit, enabled)
VALUES (1, '2020-04-02 10:06:02', '2020-04-02 10:05:57', null, null, '5', 1, '5', 1.0000, 1, null, 1.0000, 1, null, 0);
INSERT INTO shower.price_info (id, create_time, update_time, create_user, update_user, code, type, price_code,
                               time_price, time_interval, time_unit, water_price, water_interval, water_unit, enabled)
VALUES (2, '2020-04-02 10:24:56', '2020-04-16 13:41:04', null, null, '1245537668494921728', 2, '5', 6.0000, 30, 2,
        1.0000, 5, 2, 1);
INSERT INTO shower.price_info (id, create_time, update_time, create_user, update_user, code, type, price_code,
                               time_price, time_interval, time_unit, water_price, water_interval, water_unit, enabled)
VALUES (3, '2020-04-02 10:24:56', '2020-04-02 10:24:56', null, null, '1245537668792717312', 1, '3', 6.0000, 30, 2,
        1.0000, 5, 2, 1);
INSERT INTO shower.price_info (id, create_time, update_time, create_user, update_user, code, type, price_code,
                               time_price, time_interval, time_unit, water_price, water_interval, water_unit, enabled)
VALUES (4, '2020-04-02 10:32:53', '2020-04-02 10:32:53', null, null, '1245539670830485504', 1, 'A1234', 6.0000, 30, 2,
        1.0000, 5, 2, 1);
INSERT INTO shower.price_info (id, create_time, update_time, create_user, update_user, code, type, price_code,
                               time_price, time_interval, time_unit, water_price, water_interval, water_unit, enabled)
VALUES (6, '2020-04-04 17:53:17', '2020-04-16 13:41:04', null, null, '1246375275026059264', 2, '3', 6.0000, 30, 2,
        1.0000, 5, 2, 1);
INSERT INTO shower.price_info (id, create_time, update_time, create_user, update_user, code, type, price_code,
                               time_price, time_interval, time_unit, water_price, water_interval, water_unit, enabled)
VALUES (7, '2020-04-04 17:53:17', '2020-04-16 13:41:20', null, null, '1246375275353214976', 2, 'A1234', 6.0000, 30, 2,
        1.0000, 5, 2, 1);