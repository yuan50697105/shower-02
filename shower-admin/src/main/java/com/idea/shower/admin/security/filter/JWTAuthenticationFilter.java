...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public JWTAuthenticationFilter(AuthenticationManager authenticationManager) {
        ...
        super.setFilterProcessesUrl("/security/login");
    }
    ...
    protected void successfulAuthentication(HttpServletRequest request,
        ...
        String token = JwtTokenUtils.createToken(jwtUser.getId(), jwtUser.getUsername(), authoritiesList);
        ...
        map.put("token", token);
        response.getWriter().write(JSONUtil.toJsonPrettyStr(ResultInfo.success(map)));
    }
